...
conv3b = Conv2D(256, kernel_size=3, padding='same', use_bias=False)(d3a)
d3b = LeakyReLU()(conv3b)

conv8a = Conv2D(128, kernel_size=8, padding='same', use_bias=False)(input)
d8a = LeakyReLU()(conv8a)

conv8b = Conv2D(256, kernel_size=8, padding='same', use_bias=False)(d8a)
...
dense1 = Dense(10000, LeakyReLU(), use_bias=False)(concatted1)

concatted2 = Concatenate()([flatInput,  dense1])
dense2 = Dense(5000, LeakyReLU(), use_bias=False)(concatted2)
...
model.summary()
model.save('./models/blanks/c2d2_L_v1')

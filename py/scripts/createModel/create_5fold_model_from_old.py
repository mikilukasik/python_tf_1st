...
def merge_outputs(inputs):
    ...
    output_1, output_2, output_3, output_4, output_5, ratios = inputs
...
merged_output = Lambda(merge_outputs)(
    [output_1, output_2, output_3, output_4, output_5, ratios])
...
save_model(merged_model, '../models/merged_5models_fo/_orig')

...
model_1 = create_champ_model(filter_nums=[16, 32, 64, 128, 256],
...
model_2 = create_champ_model(filter_nums=[16, 32, 64, 128, 256, 512],
                             layers_per_conv_block=2,
...
model_3 = create_champ_model(filter_nums=[16, 32, 64, 128, 256, 512],
                             layers_per_conv_block=2,
                             dense_units=[1024, 1024, 1024],
                             layers_per_dense_block=1,
                             dropout_rate=0.25,
...
model_1._name = 'model_1_0-20'
model_2._name = 'model_2_20-60'
model_3._name = 'model_3_60-100'
...
save_model(merged_model, '../models/3fold_M/_orig')

...
from utils.plot_learning_rate_stats import plot_learning_rate_stats
...
if __name__ == "__main__":
    ...
    filename = f'./learning_rate_stats.pdf'
    print('filename', filename)

    plot_learning_rate_stats(model_meta, filename, True)
